...
<style>
    form input {
        ...
        margin-right: 35px;     /* Adds space to the right of each input field */
        border-radius: 5px;     /* Optional: Adds rounded corners to input fields */
        border: 1px solid #172147; /* Adds a border around input fields */
        border-color: #172147;
...
<!-- Updated container: logo on the left, form on the right -->
<div class="d-flex align-items-center justify-content-center" style="min-height: 100vh;">
    <div class="d-flex flex-row" style="width: 100%; max-width: 1000px;">
        <!-- Logo Section (Left Side) -->
        <div class="p-4" style="flex: 1; display: flex; align-items: center; justify-content: center;">
            <img src="assets/images/logo2.png" alt="GHAR TUITION" style="width: 350px; margin-left:-250px">
        </div>

        <!-- Form Section (Right Side) -->
        <div class="p-9" style="flex: 2;margin-left: 10px;">
        <h1 style="font-weight: bold; margin-bottom:40px; text-align:center;">Log in Your Account</h1>
            ...
            <form method="post" action="" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6" style="padding-right: 33px;">
                        <label for="first_name">First Name</label>
                        <input type="text" name="first_name" id="first_name" class="form-control" style="padding-right: 33px;" required
                ...
                <div class="form-row">
                    <div class="form-group col-6" style="padding-right: 33px;">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="role" id="role" class="form-control">
                            <option value="parent" <?php if(isset($_POST['role']) && $_POST['role']=='parent') echo 'selected'; ?>>
                                Parent/Student</option>
                            <option value="tutor" <?php if(isset($_POST['role']) && $_POST['role']=='tutor') echo 'selected'; ?>>
                                Tutor</option>
                        </select>
                    </div>
                </div>
                ...
                <div id="tutor_fields" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tutor_location" id="tutor_location" class="form-control" required>
                            ...
                            <option value="Kathmandu" <?php if(isset($_POST['tutor_location']) && $_POST['tutor_location']=='Kathmandu') echo 'selected'; ?>>
                                Kathmandu</option>
                            <option value="Bhaktapur" <?php if(isset($_POST['tutor_location']) && $_POST['tutor_location']=='Bhaktapur') echo 'selected'; ?>>
                                Bhaktapur</option>
                            <option value="Lalitpur" <?php if(isset($_POST['tutor_location']) && $_POST['tutor_location']=='Lalitpur') echo 'selected'; ?>>
                                Lalitpur</option>
                        </select>
                    </div>
                </div>
                ...
                <!-- Submit Button -->
                <button type="submit" class="btn btn-primary btn-block" style="background-color: #172147;">Sign Up</button>
            </form>
