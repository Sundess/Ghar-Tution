        ...
        <div class="row">
            ...
            <div class="col-md-2 mb-2">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="text-white-50">NEB</a></li>
                    <li><a href="#" class="text-white-50">Mathematics</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-2 mb-2">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="text-white-50">Become Tutor</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <p class="mb-0 text-white-50">
                    © 2023 GharTution. Developed by Group 4. All rights reserved.
                </p>
            </div>
