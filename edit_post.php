...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(empty($error)) {
        ...
        $stmt->execute([$title, $description, $tuition_type, $gender_preferred, $grade, $subjects, $class_start_time, $class_duration, $no_of_students, $category, $price, $post_id, $user_id]);
        header("Location: manage_posts.php");
        exit();
    }
}
        ...
        <form method="post" action="" novalidate>
            ...
            <div class="form-group">
                ...
                <select name="tuition_type" class="form-control" required>
                    <option value="online" <?php if($post['tuition_type']=='online') echo 'selected'; ?>>Online</option>
                    <option value="offline" <?php if($post['tuition_type']=='offline') echo 'selected'; ?>>Offline
                    </option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="gender_preferred" class="form-control" required>
                    <option value="any" <?php if($post['gender_preferred']=='any') echo 'selected'; ?>>Any</option>
                    <option value="male" <?php if($post['gender_preferred']=='male') echo 'selected'; ?>>Male</option>
                    <option value="female" <?php if($post['gender_preferred']=='female') echo 'selected'; ?>>Female
                    </option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="grade" class="form-control" required>
                    <option value="Grade 1-5" <?php if($post['grade']=='Grade 1-5') echo 'selected'; ?>>Grade 1-5
                    </option>
                    <option value="Grade 5-8" <?php if($post['grade']=='Grade 5-8') echo 'selected'; ?>>Grade 5-8
                    </option>
                    <option value="Grade 9-10" <?php if($post['grade']=='Grade 9-10') echo 'selected'; ?>>Grade 9-10
                    </option>
                    <option value="+2" <?php if($post['grade']=='+2') echo 'selected'; ?>>+2</option>
                    <option value="Bachelors" <?php if($post['grade']=='Bachelors') echo 'selected'; ?>>Bachelors
                    </option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="category" class="form-control" required>
                    <option value="For 3 months" <?php if($post['category']=='For 3 months') echo 'selected'; ?>>For 3
                        months</option>
                    <option value="For exam only" <?php if($post['category']=='For exam only') echo 'selected'; ?>>For
                        exam only</option>
                    <option value="For whole year" <?php if($post['category']=='For whole year') echo 'selected'; ?>>For
                        whole year</option>
                </select>
            </div>
